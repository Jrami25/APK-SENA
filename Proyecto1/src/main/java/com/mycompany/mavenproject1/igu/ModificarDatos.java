...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    private void cargarDatos(int id_Owner){
        
        Carowner car = control.dataCar(id_Owner);
       txtBrand.setText(car.getBrand);
       txtCC.setText("car.getCC_Owner");
       txtDate.setText("car.getDate");
       txtDescription.setText("car.getDescriptionf");
       txtModel.setText("car.getModel");
       txtRegistrationf.setText("car.Registrationf");
       txtOwnersName.setText("car.getOwnersName");
